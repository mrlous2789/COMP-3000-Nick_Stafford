...
namespace Mer
{
	...
	void GameState::Draw(float dt)
	{
		...
		if (GUI.Button(1600, 750, 50, 50, _data->assets.getTexture("terrainB"), "Speed1"))
		{
			PLC.SetTickSpeed(1);
		}
		if (GUI.Button(1655, 750, 50, 50, _data->assets.getTexture("nationB"), "Speed2"))
		{
			PLC.SetTickSpeed(2);
		}
		if (GUI.Button(1710, 750, 50, 50, _data->assets.getTexture("cultureB"), "Speed3"))
		{
			PLC.SetTickSpeed(3);
		}
		if (GUI.Button(1765, 750, 50, 50, _data->assets.getTexture("religionB"), "Speed4"))
		{
			PLC.SetTickSpeed(4);
		}
		if (GUI.Button(1825, 750, 50, 50, _data->assets.getTexture("religionB"), "Speed5"))
		{
			PLC.SetTickSpeed(5);
		}
